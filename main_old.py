...
AREA_WIDTH_M = 5.0
AREA_HEIGHT_M = 5.0
VIDEO_PATH = r"D:\Stuff\ok\MASTER\VC\cam1_1hour.mp4"
#VIDEO_PATH = r"D:\Stuff\ok\MASTER\VC\out.avi"
...
def click_event(event, x, y, flags, param):
    """Mouse callback to collect 4 calibration points."""
...
def pixel_to_meters(point, H, frame_shape):
    ...
    if H is not None:
        ...
        real_y = (H_img - y_pix) * (AREA_HEIGHT_M / H_img)  # flip Y
...
def main():
    ...
    for result in model.track(source=VIDEO_PATH, show=False, stream=True, agnostic_nms=True):
        ...
        if homography_matrix is None and frame_count == 1:
            ...
            print("Click 4 corners of the area (starting bottom-left, clockwise). Press ESC to skip.")
